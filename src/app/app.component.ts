...
export class AppComponent implements OnInit, OnDestroy {
  ...
  async sendMessage(event: Event) {
    ...
    try {
      ...
      let response: string;
      if (isWorldQuestion) {
        response = "It depends on who you ask, but your guess is as good as mine.";
      } else {
  ...
  getDailyJoke(): string {
    ...
    const jokes = [
      ...
      // WEEK 2: AGENCY LIFE (CYNICAL OBSERVATION + SIMPLE TRUTH)
      ...
      // WEEK 3: CONSULTING REALITY ("..." PAUSE JOKES)
      ...
      // WEEK 4: BILLABLE HOURS & BUDGETS (ABSURD ESCALATION)
      ...
      // WEEK 5: BRAND STRATEGY REALITY (SELF-AWARE CYNICISM)
      ...
      // WEEK 6: MEETINGS & PROCESS (BONUS MIX)
